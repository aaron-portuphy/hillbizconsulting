...
import './Home.css'
import BannerImage from '../../assets/banner/banner-img.webp'
        ...
        <section id="home">
            ...
            <div className="container">
                <div className="banner_outer">
                    <div className="col">
                        <h3 className="title">
                            WE EMPOWER YOUR <span>BUSINESS</span> 
                        </h3>
                        <p>We are more than consultants; we are partners dedicated to cultivating growth, empowering success, and turning your visions into victories. </p>
